...
func (x *orderServiceCreateOrderClient) Send(m *CreatOrderReq) error {
...
func (x *orderServiceCreateOrderServer) Recv() (*CreatOrderReq, error) {
	m := new(CreatOrderReq)
